...
def downgrade():
    ...
    op.create_table('pma__savedsearches',
                    ...
                    sa.Column('username', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('db_name', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('search_name', mysql.VARCHAR(collation='utf8_bin', length=64),
    ...
    op.create_table('pma__relation',
                    sa.Column('master_db', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('master_table', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('master_field', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('foreign_db', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('foreign_table', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('foreign_field', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
    ...
    op.create_table('pma__history',
                    ...
                    sa.Column('username', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('db', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('table', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('timevalue', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'),
                              nullable=False),
    ...
    op.create_table('pma__table_uiprefs',
                    ...
                    sa.Column('last_update', mysql.TIMESTAMP(),
    ...
    op.create_table('pma__bookmark',
                    ...
                    sa.Column('dbase', mysql.VARCHAR(collation='utf8_bin', length=255), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('user', mysql.VARCHAR(collation='utf8_bin', length=255), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('label', mysql.VARCHAR(charset='utf8', length=255), server_default=sa.text("''"),
                              nullable=False),
    ...
    op.create_table('pma__central_columns',
                    ...
                    sa.Column('col_extra', mysql.VARCHAR(collation='utf8_bin', length=255),
    ...
    op.create_table('pma__userconfig',
                    sa.Column('username', mysql.VARCHAR(collation='utf8_bin', length=64), nullable=False),
                    sa.Column('timevalue', mysql.TIMESTAMP(),
                              server_default=sa.text('CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP'), nullable=False),
    ...
    op.create_table('pma__table_coords',
                    sa.Column('db_name', mysql.VARCHAR(collation='utf8_bin', length=64), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('table_name', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('pdf_page_number', mysql.INTEGER(display_width=11), server_default=sa.text("'0'"),
    ...
    op.create_table('pma__usergroups',
                    ...
                    sa.Column('allowed', mysql.ENUM('Y', 'N', collation='utf8_bin'), server_default=sa.text("'N'"),
                              nullable=False),
    ...
    op.create_table('pma__table_info',
                    ...
                    sa.Column('table_name', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('display_field', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
    ...
    op.create_table('pma__tracking',
                    sa.Column('db_name', mysql.VARCHAR(collation='utf8_bin', length=64), nullable=False),
                    sa.Column('table_name', mysql.VARCHAR(collation='utf8_bin', length=64), nullable=False),
                    sa.Column('version', mysql.INTEGER(display_width=10, unsigned=True), autoincrement=False,
                              nullable=False),
                    ...
                    sa.Column('tracking_active', mysql.INTEGER(display_width=1, unsigned=True),
                              server_default=sa.text("'1'"), autoincrement=False, nullable=False),
    ...
    op.create_table('pma__column_info',
                    ...
                    sa.Column('table_name', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('column_name', mysql.VARCHAR(collation='utf8_bin', length=64),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('comment', mysql.VARCHAR(charset='utf8', length=255), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('mimetype', mysql.VARCHAR(charset='utf8', length=255), server_default=sa.text("''"),
                              nullable=False),
                    sa.Column('transformation', mysql.VARCHAR(collation='utf8_bin', length=255),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('transformation_options', mysql.VARCHAR(collation='utf8_bin', length=255),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('input_transformation', mysql.VARCHAR(collation='utf8_bin', length=255),
                              server_default=sa.text("''"), nullable=False),
                    sa.Column('input_transformation_options', mysql.VARCHAR(collation='utf8_bin', length=255),
                              server_default=sa.text("''"), nullable=False),
                    sa.PrimaryKeyConstraint('id'),
                    mysql_collate='utf8_bin',
    ...
    op.create_table('pma__pdf_pages',
                    ...
                    sa.Column('page_descr', mysql.VARCHAR(charset='utf8', length=50), server_default=sa.text("''"),
                              nullable=False),
